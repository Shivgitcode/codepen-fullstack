  ...
  return (
    <div className="flex justify-between items-center py-2 px-5 bg-black border-b-[2px] border-gray-700">
      ...
      <div className="flex items-center gap-5">
        <button
          className="flex items-center py-[10px] px-[12px] bg-[#444857] rounded text-white text-[15px] font-semibold gap-2 cursor-pointer hover:bg-[#696f86] transition-all"
          onClick={() => handleSubmission(params.id)}
        >
          <IoCloud></IoCloud>
          <span>Save</span>
        </button>
